...
public enum OrderError implements ErrorType {
  ...
  ORDER_ALREADY_EXIST(HttpStatus.BAD_REQUEST, "ERR-02-001", "이미 등록되었습니다."),
  ORDER_ALREADY_CANCEL(HttpStatus.BAD_REQUEST, "ERR-02-002", "이미 취소된 주문입습니다."),
  ORDER_INSERT_ERROR(HttpStatus.BAD_REQUEST, "ERR-02-002", "주문 도중 에러가 발생하였습니다."),
